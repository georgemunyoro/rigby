# Live lighting and technical reference

[← Back to the README](../README.md) · [Orchestrator guide](orchestrator.md)

Detailed controls, audio behaviour, device calibration, and development notes.
...
Example hardware patch (device names and counts depend on your setup):
